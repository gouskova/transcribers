...
# ===================================================
# degemination -- defines a degemination function and implements it
# ===================================================
degem_pair = {
    u"pp": u"p",
    u"bb": u"b",
...
def do_merger_rules(word):
    for char in merger.keys():
        word = word.replace(char, merger[char])
    return word
...
wordlist = []
with open("C:/Users/ildi/Dropbox/NYELVESZET/GitHub/transcribers/hungarian/preparation/hun_wordlist.csv") as f:
...
for word in wordlist:
    trans_word = transcribe(word, "yes", "no")
    wordlist_trans.append(trans_word)

import codecs

#text_file = codecs.open("hun_UCLAPL_wordlist.txt", "w", "utf-8")
text_file = codecs.open("hun_IPA_wordlist.txt", "w", "utf-8")
#text_file = codecs.open("hun_MGL_wordlist.txt", "w", "utf-8")
